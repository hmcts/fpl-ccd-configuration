...
module.exports = function () {
	return actor({
		...
		clickHyperlinkAndReturnToOriginalPage(link, pageGoingTo, originalPage) {
			this.click(link);
			this.seeCurrentUrlEquals(pageGoingTo);
			this.clickBrowserBack();
			this.seeInCurrentUrl(originalPage);
		},
	});
};
