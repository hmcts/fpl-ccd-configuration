...
module.exports = {
  fields: {
    proceedingType: {
      c6: locate('input').withAttr({id: 'noticeOfProceedings-proceedingTypes-NOTICE_OF_PROCEEDINGS_FOR_PARTIES'}),
      c6a: locate('input').withAttr({id: 'noticeOfProceedings-proceedingTypes-NOTICE_OF_PROCEEDINGS_FOR_NON_PARTIES'}),
    },
  },
