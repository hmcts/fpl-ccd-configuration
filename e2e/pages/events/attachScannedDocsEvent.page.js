...
module.exports = {
  ...
  fields: {
    scannedDoc: {
      ...
      scannedDate: '#scannedDocuments_0_scannedDate',
      deliveryDate: '#scannedDocuments_0_deliveryDate',
  ...
  async enterScannedDocument(scannedDocument, file) {
    ...
    I.wait(1); //TODO investigate, without this next instruction does not type entire text and goes to next line
