...
module.exports = {
  ...
  async selectSenderType() {
    I.waitForElement(this.fields.senderType.id);
    await I.runAccessibilityTest();
    I.selectOption(this.fields.senderType.id, this.fields.senderType.options.CTCS);
  },
  async selectRecipientType() {
    I.waitForElement(this.fields.recipientType.id);
    await I.runAccessibilityTest();
    I.selectOption(this.fields.recipientType.id, this.fields.recipientType.options.HearingJudge);
  },
