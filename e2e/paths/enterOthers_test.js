...
Scenario('Complete entering others details in the c110a application', (I, enterOthersPage, caseViewPage) => {
  ...
  I.seeAnswerInTab(1, 'Other persons 1', 'Full name', 'John Smith');
  I.seeAnswerInTab(2, 'Other persons 1', 'Date of birth', '1 Jan 1985');
  I.seeAnswerInTab(3, 'Other persons 1', 'Gender', 'Male');
  I.seeAnswerInTab(4, 'Other persons 1', 'Place of birth', 'Scotland');
  I.seeAnswerInTab(5, 'Other persons 1', 'Current address', '123 London lane, London');
  I.seeAnswerInTab(6, 'Other persons 1', 'Telephone number', '07888288288');
  I.seeAnswerInTab(7, 'Other persons 1', 'What is this person’s relationship to the child or children in this case?', 'Tim Smith');
  I.seeAnswerInTab(8, 'Other persons 1', 'Do you need contact details hidden from other parties?', 'Yes');
  I.seeAnswerInTab(9, 'Other persons 1', 'Give reason', 'mock reason');
  I.seeAnswerInTab(10, 'Other persons 1', 'Does this person have any issues with litigation capacity?', 'No');
});
