...
Scenario('Entering all information for first respondent and an additional respondent', (I, enterRespondentsPage, caseViewPage) => {
  ...
  I.seeAnswerInTab(8, 'Party', 'Gender', respondents[0].gender);
  I.seeAnswerInTab(9, 'Party', 'Place of birth', respondents[0].placeOfBirth);
  I.seeAnswerInTab(10, 'Party', 'What is the respondent’s relationship to the child or children in this case?',
    'mock reason');
  ...
  I.seeAnswerInTab(8, 'Party', 'Gender', respondents[1].gender);
  I.seeAnswerInTab(9, 'Party', 'Place of birth', respondents[1].placeOfBirth);
  I.seeAnswerInTab(10, 'Party', 'What is the respondent’s relationship to the child or children in this case?',
    'mock reason');
  I.seeAnswerInTab(11, 'Party', 'Do you need contact details hidden from anyone?', 'Yes');
  I.seeAnswerInTab(12, 'Party', 'Give reason', 'mock reason');
