...
Scenario('completing entering child information in the c110a application', (I, enterChildrenPage, caseViewPage) => {
  ...
  I.seeEventSubmissionConfirmation(config.applicationActions.enterChildren);
  caseViewPage.selectTab(caseViewPage.tabs.casePeople);
  I.seeAnswerInTab(1, 'Party', 'Party type', 'Individual');
  ...
  I.seeAnswerInTab(9, 'Party', 'What date did they start staying here?', '1 Nov 2017');
  ...
  I.seeAnswerInTab(17, 'Party', 'Social worker\'s telephone number', '01234567');
  ...
  I.seeAnswerInTab(9, 'Party', 'Key dates for this child', 'Tuesday the 11th');
  I.seeAnswerInTab(10, 'Party', 'Brief summary of care and contact plan', 'care plan summary');
  I.seeAnswerInTab(11, 'Party', 'Are you considering adoption at this stage?', 'No');
  I.seeAnswerInTab(12, 'Party', 'Mother\'s full name', 'Laura Smith');
  I.seeAnswerInTab(13, 'Party', 'Father\'s full name', 'David Smith');
  I.seeAnswerInTab(14, 'Party', 'Does the father have parental responsibility?', 'Yes');
  I.seeAnswerInTab(15, 'Party', 'Name of social worker', 'James Jackson');
  I.seeAnswerInTab(16, 'Party', 'Social worker\'s telephone number', '01234567');
  I.seeAnswerInTab(17, 'Party', 'Does the child have any additional needs?', 'No');
  I.seeAnswerInTab(18, 'Party', 'Do you need contact details hidden from other parties?', 'No');
  I.seeAnswerInTab(19, 'Party', 'Do you believe this child will have problems with litigation capacity (understanding what\'s happening in the case)', 'No');
});
