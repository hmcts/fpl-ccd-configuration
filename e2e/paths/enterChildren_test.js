...
Scenario('completing entering child information in the c110a application', (I, enterChildrenPage, caseViewPage) => {
  ...
  I.seeEventSubmissionConfirmation(config.applicationActions.enterChildren);
  caseViewPage.selectTab(caseViewPage.tabs.casePeople);
  I.seeAnswerInTab(2, 'Party', 'First name', 'Bran');
  I.seeAnswerInTab(3, 'Party', 'Last name', 'Stark');
  I.seeAnswerInTab(4, 'Party', 'Date of birth', '1 Aug 2015');
  I.seeAnswerInTab(5, 'Party', 'Gender', 'Boy');
  ...
  I.seeAnswerInTab(6, 'Party', 'Describe child\'s situation', 'Living with respondents');
  ...
  I.seeAnswerInTab(6, 'Current address', 'Country', 'United Kingdom');
  I.seeAnswerInTab(6, 'Party', 'Describe child\'s situation', 'Living with respondents');
  I.seeAnswerInTab(7, 'Party', 'What date did they start staying here?', '2 Nov 2017');
