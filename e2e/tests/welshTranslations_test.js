...
xScenario('Can upload translation only if language requirement is set', async ({ I, caseViewPage, enterLanguageRequirementsEventPage }) => {
...
xScenario('Upload translation for generated order @nightlyOnly', async ({ I, caseViewPage, uploadWelshTranslationsPage }) => {
  await setupScenario(I);
...
xScenario('Request and upload translation for C110A @nightlyOnly', async ({ I, caseViewPage, uploadWelshTranslationsPage, enterLanguageRequirementsEventPage, submitApplicationEventPage }) => {
...
xScenario('Request and upload translation for uploaded order @nightlyOnly', async ({ I, caseViewPage, uploadWelshTranslationsPage, manageOrdersEventPage }) => {
...
xScenario('Request and upload translation for standard directions order @nightlyOnly', async ({ I, caseViewPage, uploadWelshTranslationsPage, draftStandardDirectionsEventPage }) => {
  let caseId = await I.submitNewCaseWithData(caseDataGatekeepingWithLanguage);
...
xScenario('Upload translation for notice of proceedings (C36) @nightlyOnly', async ({ I, caseViewPage, uploadWelshTranslationsPage }) => {
  await setupScenario(I);
...
xScenario('Upload translation for notice of proceedings - others (C36A) @nightlyOnly', async ({ I, caseViewPage, uploadWelshTranslationsPage }) => {
  await setupScenario(I);
...
xScenario('Request and upload translation for urgent hearing order @nightlyOnly', async ({ I, caseViewPage, uploadWelshTranslationsPage, draftStandardDirectionsEventPage }) => {
  let caseId = await I.submitNewCaseWithData(caseDataGatekeepingWithLanguage);
  await I.navigateToCaseDetailsAs(config.gateKeeperUser, caseId);
...
xScenario('Request and upload translation for case management order @nightlyOnly', async ({ I, caseViewPage, uploadWelshTranslationsPage, uploadCaseManagementOrderEventPage, reviewAgreedCaseManagementOrderEventPage }) => {
...
xScenario('Upload translation for generated order (closed) @nightlyOnly', async ({ I, caseViewPage, uploadWelshTranslationsPage }) => {
  await setupScenario(I, closedCaseData);
  await translateOrder(I, caseViewPage, uploadWelshTranslationsPage, orders.generated);
  assertTranslation(I, caseViewPage, orders.generated);
});

xScenario('Request and upload translation for notice of hearing @nightlyOnly', async ({ I, caseViewPage, uploadWelshTranslationsPage, manageHearingsEventPage }) => {
  let caseId = await I.submitNewCaseWithData(caseDataCaseManagementWithLanguage);
  await I.navigateToCaseDetailsAs(config.hmctsAdminUser, caseId);
...
xScenario('Request and upload translation for HMCTS further evidence documents @nightlyOnly', async ({ I, caseViewPage, uploadWelshTranslationsPage, manageDocumentsEventPage }) => {
  let caseId = await I.submitNewCaseWithData(caseDataCaseManagementWithLanguage);
  await I.navigateToCaseDetailsAs(config.hmctsAdminUser, caseId);
