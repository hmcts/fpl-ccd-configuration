...
Scenario('HMCTS Admin and LA upload confidential Other applications supporting documents @flaky-fix-Feb', async ({I, caseViewPage, manageDocumentsEventPage, manageDocumentsLAEventPage, uploadAdditionalApplicationsEventPage}) => {
  await setupScenario(I);
