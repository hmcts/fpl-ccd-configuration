...
Scenario('Secondary local authority solicitor can see all local authorities but updates only his own @fix-flaky-Feb', async ({I, caseViewPage, enterLocalAuthorityEventPage}) => {
