...
xScenario('HMCTS admin is not able to see last court when previous hearings venue exist @nightlyOnly', async ({I, caseViewPage, manageHearingsEventPage}) => {
...
xScenario('HMCTS admin is able to see last court when previous hearings venue exist @nightlyOnly', async ({I, caseViewPage, manageHearingsEventPage}) => {
...
xScenario('HMCTS admin creates subsequent hearings with previous hearing not having hearing venue @nightlyOnly', async ({I, caseViewPage, manageHearingsEventPage}) => {
  await setupScenario(I, true);
