...
xScenario('HMCTS admin uploads documents to be scanned @nightlyOnly', async ({I, caseViewPage, handleSupplementaryEvidenceEventPage, attachScannedDocsEventPage}) => {
...
xScenario('HMCTS admin can see documents scanned in with Bulk Scan @nightlyOnly', async ({I, caseViewPage}) => {
  await setupScenario(I);
