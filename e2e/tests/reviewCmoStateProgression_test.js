...
Scenario('Judge transitions CMO to final hearing case state @failure @debug-failure', async ({I, caseViewPage, uploadCaseManagementOrderEventPage, reviewAgreedCaseManagementOrderEventPage}) => {
