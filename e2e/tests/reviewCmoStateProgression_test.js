...
Scenario('Judge transitions CMO to final hearing case state @failure', async ({I, caseViewPage, uploadCaseManagementOrderEventPage, reviewAgreedCaseManagementOrderEventPage}) => {
