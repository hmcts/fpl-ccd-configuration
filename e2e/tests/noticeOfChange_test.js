...
Scenario('Solicitor can request representation of a respondent @fix-flaky-Feb', async ({I, caseListPage, caseViewPage, submitApplicationEventPage, noticeOfChangePage, enterRespondentsEventPage}) => {
