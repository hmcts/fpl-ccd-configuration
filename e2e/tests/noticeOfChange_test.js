...
xScenario('Solicitor can request representation of a respondent @nightlyOnly', async ({I, caseListPage, caseViewPage, submitApplicationEventPage, noticeOfChangePage, enterRespondentsEventPage}) => {
  await setupScenario();
