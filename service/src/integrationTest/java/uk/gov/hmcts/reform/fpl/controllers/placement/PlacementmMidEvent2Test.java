...
class PlacementmMidEvent2Test extends AbstractCallbackTest {

    @MockBean
    private FeesRegisterApi feesRegisterApi;

    PlacementmMidEvent2Test() {
        super("placement");
    }
    ...
    void shouldFetchPlacementFeeWhenPaymentIsRequired() {
        ...
        final CaseData updatedCaseData = extractCaseData(postMidEvent(caseData, "documents"));
