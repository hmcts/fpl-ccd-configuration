...
class PlacementApplicationEventHandlerEmailTemplateTest extends EmailTemplateTest {
    ...
    void courtNotification() {
        ...
        underTest.notifyAdmin(new PlacementApplicationSubmitted(caseData, placement));

        assertThat(response())
            .hasSubject("New placement application, Alex Green")
            .hasBody(emailContent()
                .line(format("A new or amended placement application has been issued by the %s, or a response has been provided.", LOCAL_AUTHORITY_1_NAME))
                .line()
                .line(format("To view it, sign into %s", caseDetailsUrl(CASE_ID, PLACEMENT)))
                .line()
                .line("You should now:")
                .list("check the application", "send it to the judge or legal advisor", "send documents to relevant parties")
                .line()
                .line(FOOTER_HEADER)
                .line()
    ...
    void localAuthorityNotification() {
        ...
        assertThat(response())
            ...
            .hasBody(emailContent()
                .line(format("A new or amended notice of placement has been issued by the %s, or a response has been provided.", LOCAL_AUTHORITY_1_NAME))
                .line()
                .line(format("To view it, sign into %s", caseDetailsUrl(CASE_ID, PLACEMENT)))
                .line()
                .line(FOOTER_HEADER)
    ...
    void cafcassNotification() {
        ...
        assertThat(response())
            ...
            .hasBody(emailContent()
                ...
                .line()
                .h1("Next steps")
                .list("You can now start to prepare for the hearing", "You can review the application by using link http://fake-url/100/binary")
                .line("or")
