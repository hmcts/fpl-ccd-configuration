...
class PlacementAboutToStartControllerTest extends AbstractCallbackTest {
    ...
    void shouldPrepareCaseDataWhenManyChildrenWithoutPlacement() {
        ...
        assertThat(placementEventData.getPlacementChildrenCardinality()).isEqualTo(MANY);
        assertThat(placementEventData.getPlacementChildName()).isNull();
        assertThat(placementEventData.getPlacement()).isNull();
        assertThatDynamicList(placementEventData.getPlacementChildrenList()).hasSize(2)
    ...
    void shouldPrepareCaseDataWhenSingleChildWithoutPlacement() {
        ...
        assertThat(placementEventData.getPlacementChildrenCardinality()).isEqualTo(ONE);
        ...
        assertThat(placementEventData.getPlacement()).isEqualTo(Placement.builder()
            ...
            .build());
        assertThat(placementEventData.getPlacementChildrenList()).isNull();
    }
