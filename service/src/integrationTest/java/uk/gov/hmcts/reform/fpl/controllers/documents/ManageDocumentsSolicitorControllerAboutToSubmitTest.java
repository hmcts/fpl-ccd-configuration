...
class ManageDocumentsSolicitorControllerAboutToSubmitTest extends AbstractCallbackTest {
    ...
    ManageDocumentsSolicitorControllerAboutToSubmitTest() {
        super("manage-documents-solicitor");
    }
    ...
    void shouldPopulateFurtherDocumentsCollection() {
        ...
        assertThat(extractedCaseData.getFurtherEvidenceDocumentsSolicitor()).isEqualTo(furtherEvidenceBundle);
        assertExpectedFieldsAreRemoved(extractedCaseData);
    ...
    void shouldPopulateCorrespondenceEvidenceCollection() {
        ...
        assertThat(extractedCaseData.getCorrespondenceDocumentsSolicitor()).isEqualTo(expectedDocuments);
        assertExpectedFieldsAreRemoved(extractedCaseData);
