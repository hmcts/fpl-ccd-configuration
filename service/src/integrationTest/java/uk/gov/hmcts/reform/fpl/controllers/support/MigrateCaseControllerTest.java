    ...
    class DfplRemoveC110a {
        ...
        private Stream<Arguments> provideMigrationTestData() {
            return Stream.of(
                ...
                Arguments.of("DFPL-709", 1654079894022178L, UUID.fromString("a36c79a6-86e4-4cee-ae29-f7e0f1c927dc")),
                Arguments.of("DFPL-710", 1643970994251861L, UUID.fromString("6900eb4e-4131-4496-92f3-10e269da9f88")),
                Arguments.of("DFPL-711", 1651739759566998L, UUID.fromString("022e4acf-28b2-4889-9ecb-322c65be5bd1"))
            );
        }
