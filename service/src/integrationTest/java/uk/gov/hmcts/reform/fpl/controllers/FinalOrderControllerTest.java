...
class FinalOrderControllerTest {
    ...
    class DocumentTests {
        ...
        void setup() {
            ...
            given(docmosisDocumentGeneratorService.generateDocmosisDocument(any(), any())).willReturn(
                docmosisDocument);
        ...
        @Test
        void midEventShouldGenerateFinalOrderDocument() throws Exception {
        ...
        private void aboutToSubmitAssertions(CaseData caseData, FinalOrder expectedOrder) {
            ...
            assertThat(caseData.getFinalOrder()).isEqualTo(null);
            assertThat(caseData.getJudgeAndLegalAdvisor()).isEqualTo(null);
            assertThat(finalOrders.get(0).getValue()).isEqualTo(expectedOrder);
        }
    }
    ...
    private Map<String, Object> commonNotificationParameters() {
        ...
        return ImmutableMap.<String, Object>builder()
            ...
            .put("hearingDetailsCallout",
                subjectLine + ", hearing " + dateFormatterService.formatLocalDateToString(
