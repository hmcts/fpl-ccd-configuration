...
import uk.gov.hmcts.reform.fpl.controllers.ManageHearingsController;
...
abstract class ListGatekeepingHearingControllerTest extends AbstractCallbackTest {

    ListGatekeepingHearingControllerTest(String eventName) {
        super(eventName);
    }
