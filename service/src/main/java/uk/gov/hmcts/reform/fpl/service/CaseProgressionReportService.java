...
public class CaseProgressionReportService {
    ...
    public String getCourt(CaseProgressionReportEventData caseProgressionReportEventData) {
        return Optional.ofNullable(caseProgressionReportEventData.getCarlisleDFJCourts())
                ...
                .orElseGet(() -> Optional.ofNullable(caseProgressionReportEventData.getCoventryDFJCourts())
                .orElseGet(() -> Optional.ofNullable(caseProgressionReportEventData.getDerbyDFJCourts())
                .orElseGet(() -> Optional.ofNullable(caseProgressionReportEventData.getLeicesterDFJCourts())
                .orElseGet(() -> Optional.ofNullable(caseProgressionReportEventData.getLincolnDFJCourts())
                .orElseGet(() -> Optional.ofNullable(caseProgressionReportEventData.getNorthamptonDFJCourts())
                .orElseGet(() -> Optional.ofNullable(caseProgressionReportEventData.getNottinghamDFJCourts())
                .orElseGet(() -> Optional.ofNullable(caseProgressionReportEventData.getWolverhamptonDFJCourts())
                .orElseGet(() -> Optional.ofNullable(caseProgressionReportEventData.getStokeOnTrentrDFJCourts())
                .orElseGet(() -> Optional.ofNullable(caseProgressionReportEventData.getWestLondonDFJCourts())
                .orElseGet(() -> Optional.ofNullable(caseProgressionReportEventData.getClevelandAndSouthDurhamDFJCourts())
                .orElseGet(() -> Optional.ofNullable(caseProgressionReportEventData.getHumbersideDFJCourts())
                .orElseGet(() -> Optional.ofNullable(caseProgressionReportEventData.getNorthYorkshireDFJCourts())
                .orElseGet(() -> Optional.ofNullable(caseProgressionReportEventData.getNorthumbriaAndNorthDurhamDFJCourts())
                .orElseGet(() -> Optional.ofNullable(caseProgressionReportEventData.getSouthYorkshireDFJCourts())
                .orElseGet(() -> Optional.ofNullable(caseProgressionReportEventData.getWestYorkshireDFJCourts())
                .orElseGet(() -> Optional.ofNullable(caseProgressionReportEventData.getBlackburnLancasterDFJCourts())
                ...
                .orElseGet(() -> Optional.ofNullable(caseProgressionReportEventData.getNorthWalesDFJCourts())
                .orElseGet(() -> Optional.ofNullable(caseProgressionReportEventData.getSouthEastWalesDFJCourts())
