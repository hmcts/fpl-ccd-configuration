...
public enum OrderQuestionBlock {
    ...
    LINK_APPLICATION("linkApplicationQuestionBlock", "Link application", OrderSection.HEARING_DETAILS,
        List.of("manageOrdersShouldAllowLinkingApplication", "manageOrdersShouldLinkApplication",
