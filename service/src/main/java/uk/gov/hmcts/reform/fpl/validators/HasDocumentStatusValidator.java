...
public class HasDocumentStatusValidator implements ConstraintValidator<HasDocumentStatus, CaseData> {
    ...
    public boolean isValid(CaseData caseData, ConstraintValidatorContext constraintValidatorContext) {
        ...
        if (caseData.checklistDocument != null || caseData.socialWorkStatementDocument != null
            || caseData.socialWorkCarePlanDocument != null || caseData.socialWorkChronologyDocument != null
            || caseData.thresholdDocument != null || caseData.socialWorkAssessmentDocument != null) {
