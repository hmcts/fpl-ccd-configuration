...
//                        .readonly(CaseData::, "hearingDate=\"DO_NOT_SHOW\"")
    ...
    private void buildPrepareForHearing() {
        ...
        event("draftCMO")
                ...
                .field().id(CaseData::getAllPartiesCustomCMO).mutable().complex(Direction.class, this::renderDirection)
                .page("localAuthorityDirections")
                    .showCondition("cmoToAction=\"\" OR cmoToAction.status!=\"SEND_TO_JUDGE\"")
                     .label("localAuthorityDirectionsLabelCMO", "## For the local authority")
                     .field().id(CaseData::getLocalAuthorityDirectionsCustomCMO).mutable().complex(Direction.class, this::renderDirection)
                .page(2)
                    .showCondition("cmoToAction=\"\" OR cmoToAction.status!=\"SEND_TO_JUDGE\"")
                     ...
                     .field().id(CaseData::getRespondentDirectionsCustomCMO).mutable().complex(Direction.class)
                ...
                .page("cafcassDirections")
                    .showCondition("cmoToAction=\"\" OR cmoToAction.status!=\"SEND_TO_JUDGE\"")
                     ...
                     .field().id(CaseData::getCafcassDirectionsCustomCMO).mutable().complex(Direction.class, this::renderDirection)
                .page(3)
                    .showCondition("cmoToAction=\"\" OR cmoToAction.status!=\"SEND_TO_JUDGE\"")
                     .label("otherPartiesDirectionLabelCMO", "## For other parties")
                     .field("others_label", DisplayContext.ReadOnly, null, "TextArea", null, " ")
                     .field().id(CaseData::getOtherPartiesDirectionsCustomCMO).mutable().complex(Direction.class)
                    .done()
                .page("courtDirections")
                    .showCondition("cmoToAction=\"\" OR cmoToAction.status!=\"SEND_TO_JUDGE\"")
                     .label("courtDirectionsLabelCMO", "## For the court")
                     .field().id(CaseData::getCourtDirectionsCustomCMO).mutable().complex(Direction.class, this::renderDirection)
                .page(5)
                    .showCondition("cmoToAction=\"\" OR cmoToAction.status!=\"SEND_TO_JUDGE\"")
