...
public class MigrateCaseController extends CallbackController {
    ...
    public void handleSubmitted(@RequestBody CallbackRequest callbackRequest) {
        ...
        if ("FPLA-2946".equals(migrationId) && "WR21C50052".equals(caseData.getFamilyManCaseNumber())) {
    ...
    private void run2946(CaseDetails caseDetails) {
        ...
        if ("WR21C50052".equals(caseData.getFamilyManCaseNumber())) {
            ...
            if (!"WSC".equals(caseData.getCaseLocalAuthority())) {
                throw new IllegalStateException(
                    String.format("Expected local authority %s, but got %s", "WSC", caseData.getCaseLocalAuthority()));
            }

            caseDetails.getData().put("caseLocalAuthority", "DEV");
            caseDetails.getData().put("caseLocalAuthorityName", "Devon County Council");
            caseDetails.getData().put("localAuthorityPolicy", organisationPolicy(
                "ZBGD22I", "Devon County Council", CaseRole.LASOLICITOR));
        } else {
