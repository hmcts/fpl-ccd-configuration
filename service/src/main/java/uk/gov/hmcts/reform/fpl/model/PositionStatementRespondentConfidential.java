...
public class PositionStatementRespondentConfidential {
    @CCD(
            label = "Hearing Id",
            showCondition = "hearingId=\"DO NOT SHOW\""
    )
    private String hearingId;

    @CCD(
            label = "Position statement respondent for"
    )
    ...
    @CCD(
            label = "Respondent",
            showCondition = "respondentId=\"DO NOT SHOW\""
    )
