...
public class ApprovalDateTimeValidator implements QuestionBlockOrderValidator {
    public static final String END_DATE_RANGE_MESSAGE = "Approval date cannot be more than 1 year in the future";
    ...
    public List<String> validate(CaseData caseData) {
        ...
        final LocalDateTime rangeEnd = approvalDateTime.plus(APPROVAL_END_DATE_RANGE);
