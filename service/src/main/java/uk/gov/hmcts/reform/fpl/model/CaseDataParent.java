...
public class CaseDataParent {
    ...
    protected final List<Element<ManagedDocument>> swetList;
    protected final List<Element<ManagedDocument>> swetListLA;
    protected final List<Element<ManagedDocument>> swetListCTSC;
    protected final List<Element<ManagedDocument>> swetListRemoved;
    protected final List<Element<ManagedDocument>> socialWorkChronList;
    protected final List<Element<ManagedDocument>> socialWorkChronListLA;
    protected final List<Element<ManagedDocument>> socialWorkChronListCTSC;
    protected final List<Element<ManagedDocument>> socialWorkChronListRemoved;
    protected final List<Element<ManagedDocument>> genogramList;
    protected final List<Element<ManagedDocument>> genogramListLA;
    protected final List<Element<ManagedDocument>> genogramListCTSC;
    protected final List<Element<ManagedDocument>> genogramListRemoved;
    protected final List<Element<ManagedDocument>> checklistDocList;
    protected final List<Element<ManagedDocument>> checklistDocListLA;
    protected final List<Element<ManagedDocument>> checklistDocListCTSC;
    protected final List<Element<ManagedDocument>> checklistDocListRemoved;
    protected final List<Element<ManagedDocument>> birthCertList;
    protected final List<Element<ManagedDocument>> birthCertListLA;
    protected final List<Element<ManagedDocument>> birthCertListCTSC;
    protected final List<Element<ManagedDocument>> birthCertListRemoved;
    protected final List<Element<ManagedDocument>> otherDocFiledList;
    protected final List<Element<ManagedDocument>> otherDocFiledListLA;
    protected final List<Element<ManagedDocument>> otherDocFiledListCTSC;
    protected final List<Element<ManagedDocument>> otherDocFiledListRemoved;
