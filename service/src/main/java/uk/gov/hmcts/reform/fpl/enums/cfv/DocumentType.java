...
public enum DocumentType {
    ...
    ADVOCATE_MEETING_MINUTE("Advocate Meeting Minute", standardResolver("advocateMeetingMinuteList"),
            false, false, false,
        defaultWithDocumentBuilder(),
            null, 570, DEFAULT_NOTIFICATION_CONFIG, "advocateMeetingMinutes"),
    WITNESS_TEMPLATE("Witness Template", standardResolver("witnessTemplateList"),
        false, false, false,
        defaultWithDocumentBuilder(),
        null, 580, DEFAULT_NOTIFICATION_CONFIG, "witnessTemplates"),
