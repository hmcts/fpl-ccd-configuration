...
public enum DocumentType {
    ...
    RESPONDENTS_STATEMENTS("└─ Respondent statements", standardResolver("respStmtList"),
        ...
        (bundle) -> RespondentStatementV2.builder()
            ...
            .translationRequirements(bundle.getTranslationRequirement())
            .build(),
        AA_PARENT_RESPONDENTS_STATEMENTS, 220, DEFAULT_NOTIFICATION_CONFIG),
    ...
    GUARDIAN_EVIDENCE("Guardian's evidence", standardResolver("guardianEvidenceList"),
        false, false, false,
        defaultWithDocumentBuilder(),
        null, 240, NO_CAFCASS_NOTIFICATION_CONFIG),
    AA_PARENT_EXPERT_REPORTS("Expert Reports", null,
        false, false, false,
        null,
        null, 250, null),
    ADULT_PSYCHIATRIC_REPORT_ON_PARENTS("└─ Adult Psychiatric Report On Parent(s)", standardResolver("adultPsychRepParentsList"),
        false, false, false,
        defaultWithDocumentBuilder(),
        AA_PARENT_EXPERT_REPORTS, 260, DEFAULT_NOTIFICATION_CONFIG),
    FAMILY_CENTRE_ASSESSMENTS_NON_RESIDENTIAL("└─ Family Centre Assessments - Non-Residential", standardResolver("famCentreAssessNonResList"),
        false, false, false,
        defaultWithDocumentBuilder(),
        AA_PARENT_EXPERT_REPORTS, 270, DEFAULT_NOTIFICATION_CONFIG),
    FAMILY_CENTRE_ASSESSMENTS_RESIDENTIAL("└─ Family Centre Assessments - Residential", standardResolver("familyCentreAssesResList"),
        false, false, false,
        defaultWithDocumentBuilder(),
    ...
    INDEPENDENT_SOCIAL_WORKER("└─ Independent Social Worker", standardResolver("indepSocialWorkerList"),
        false, false, false,
        defaultWithDocumentBuilder(),
        AA_PARENT_EXPERT_REPORTS, 300, DEFAULT_NOTIFICATION_CONFIG),
    MULTI_DISCIPLINARY_ASSESSMENT("└─ Multi Disciplinary Assessment", standardResolver("multiDisciplinAssessList"),
        false, false, false,
        defaultWithDocumentBuilder(),
    ...
    PEDIATRIC_RADIOLOGIST("└─ Pediatric Radiologist", standardResolver("pediatricRadiologistList"),
        false, false, false,
        defaultWithDocumentBuilder(),
        AA_PARENT_EXPERT_REPORTS, 370, DEFAULT_NOTIFICATION_CONFIG),

    PROFESSIONAL_DNA_TESTING("└─ Professional: DNA Testing", standardResolver("profDNATestingList"),
        false, false, false,
        defaultWithDocumentBuilder(),
        AA_PARENT_EXPERT_REPORTS, 380, DEFAULT_NOTIFICATION_CONFIG),
    PROFESSIONAL_DRUG_ALCOHOL("└─ Professional: Drug/Alcoho", standardResolver("profDrugAlcoholList"),
        false, false, false,
        defaultWithDocumentBuilder(),
        AA_PARENT_EXPERT_REPORTS, 390, DEFAULT_NOTIFICATION_CONFIG),
    PROFESSIONAL_HAIR_STRAND("└─ Professional: Hair Strand", standardResolver("professionalHairStrandList"),
        false, false, false,
        defaultWithDocumentBuilder(),
    ...
    PSYCHIATRIC_CHILD_ONLY("└─ Psychiatric - On child only", standardResolver("psychiatricChildOnlyList"),
        false, false, false,
        defaultWithDocumentBuilder(),
        AA_PARENT_EXPERT_REPORTS, 420, DEFAULT_NOTIFICATION_CONFIG),
    PSYCHIATRIC_CHILD_AND_PARENT("└─ Psychiatric - On child and Parent(s)/carers", standardResolver("psychChildParentCarersList"),
        false, false, false,
        defaultWithDocumentBuilder(),
        AA_PARENT_EXPERT_REPORTS, 430, DEFAULT_NOTIFICATION_CONFIG),
    PSYCHOLOGICAL_REPORT_CHILD_ONLY_CLINICAL("└─ Psychological Report on Child Only - Clinical", standardResolver("psycReportChildClinList"),
        false, false, false,
        defaultWithDocumentBuilder(),
        AA_PARENT_EXPERT_REPORTS, 440, DEFAULT_NOTIFICATION_CONFIG),
    PSYCHOLOGICAL_REPORT_CHILD_ONLY_EDUCATIONAL("└─ Psychological Report on Child Only - Educational", standardResolver("psycReportChildOnlyEdList"),
        false, false, false,
        defaultWithDocumentBuilder(),
        AA_PARENT_EXPERT_REPORTS, 450, DEFAULT_NOTIFICATION_CONFIG),
    PSYCHOLOGICAL_REPORT_PARENT_AND_CHILD("└─ Psychological Report on Parent(s) and child", standardResolver("psychReportParentChildList"),
        false, false, false,
        defaultWithDocumentBuilder(),
        AA_PARENT_EXPERT_REPORTS, 460, DEFAULT_NOTIFICATION_CONFIG),
    PSYCHOLOGICAL_REPORT_PARENT_FULL_COGNITIVE("└─ Psychological Report on Parent(s) - full cognitive", standardResolver("psychRepParentFullCogList"),
        false, false, false,
        defaultWithDocumentBuilder(),
        AA_PARENT_EXPERT_REPORTS, 470, DEFAULT_NOTIFICATION_CONFIG),
    PSYCHOLOGICAL_REPORT_PARENT_FULL_FUNCTIONING("└─ Psychological Report on Parent(s) - functioning", standardResolver("psychRepParentFuncList"),
        false, false, false,
        defaultWithDocumentBuilder(),
    ...
    LETTER_OF_INSTRUCTION("└─ Letters of instruction / referrals", standardResolver("lettersOfInstructionList"),
        false, false, false,
        defaultWithDocumentBuilder(),
        AA_PARENT_EXPERT_REPORTS, 490, DEFAULT_NOTIFICATION_CONFIG),
    TOXICOLOGY_REPORT("└─ Toxicology report/statement", standardResolver("toxicologyStatementList"),
        false, false, false,
        defaultWithDocumentBuilder(),
