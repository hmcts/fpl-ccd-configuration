...
public enum DocumentType {
    ...
    ADULT_PSYCHIATRIC_REPORT_ON_PARENTS("└─ Adult Psychiatric Report On Parent(s)", standardResolver(
        ...
        false, false, false,
        defaultWithDocumentBuilder(),
        AA_PARENT_EXPERT_REPORTS, 270, DEFAULT_NOTIFICATION_CONFIG, "adultPsychRepParentsList"),
    FAMILY_CENTRE_ASSESSMENTS_NON_RESIDENTIAL("└─ Family Centre Assessments - Non-Residential",
        ...
        false, false, false,
        defaultWithDocumentBuilder(),
        AA_PARENT_EXPERT_REPORTS, 280, DEFAULT_NOTIFICATION_CONFIG, "famCentreAssessNonResList"),
    FAMILY_CENTRE_ASSESSMENTS_RESIDENTIAL("└─ Family Centre Assessments - Residential",
        standardResolver("familyCentreAssesResList"),
        false, false, false,
        defaultWithDocumentBuilder(),
        AA_PARENT_EXPERT_REPORTS, 290, DEFAULT_NOTIFICATION_CONFIG, "familyCentreAssesResList"),
    HAEMATOLOGIST("└─ Haematologist", standardResolver("haematologistList"),
        false, false, false,
        defaultWithDocumentBuilder(),
        AA_PARENT_EXPERT_REPORTS, 300, DEFAULT_NOTIFICATION_CONFIG, "haematologistList"),
    INDEPENDENT_SOCIAL_WORKER("└─ Independent Social Worker", standardResolver(
        "indepSocialWorkerList"),
        false, false, false,
        defaultWithDocumentBuilder(),
        AA_PARENT_EXPERT_REPORTS, 310, DEFAULT_NOTIFICATION_CONFIG, "indepSocialWorkerList"),
    MULTI_DISCIPLINARY_ASSESSMENT("└─ Multi Disciplinary Assessment", standardResolver(
        "multiDisciplinAssessList"),
        false, false, false,
        defaultWithDocumentBuilder(),
        AA_PARENT_EXPERT_REPORTS, 320, DEFAULT_NOTIFICATION_CONFIG, "multiDisciplinAssessList"),
    NEUROSURGEON("└─ Neurosurgeon", standardResolver("neuroSurgeonList"),
        false, false, false,
        defaultWithDocumentBuilder(),
        AA_PARENT_EXPERT_REPORTS, 330, DEFAULT_NOTIFICATION_CONFIG, "neuroSurgeonList"),
    OPHTHALMOLOGIST("└─ Ophthalmologist", standardResolver("ophthalmologistList"),
        false, false, false,
        defaultWithDocumentBuilder(),
        AA_PARENT_EXPERT_REPORTS, 340, DEFAULT_NOTIFICATION_CONFIG, "ophthalmologistList"),
    OTHER_EXPERT_REPORT("└─ Other Expert Report", standardResolver("otherExpertReportList"),
        false, false, false,
        defaultWithDocumentBuilder(),
        AA_PARENT_EXPERT_REPORTS, 350, DEFAULT_NOTIFICATION_CONFIG, "otherExpertReportList"),
    OTHER_MEDICAL_REPORT("└─ Other Medical Report", standardResolver("otherMedicalReportList"),
        false, false, false,
        defaultWithDocumentBuilder(),
        AA_PARENT_EXPERT_REPORTS, 360, DEFAULT_NOTIFICATION_CONFIG, "otherMedicalReportList"),
    PEDIATRIC("└─ Pediatric", standardResolver("pediatricList"),
        false, false, false,
        defaultWithDocumentBuilder(),
        AA_PARENT_EXPERT_REPORTS, 370, DEFAULT_NOTIFICATION_CONFIG, "pediatricList"),
    PEDIATRIC_RADIOLOGIST("└─ Pediatric Radiologist", standardResolver(
        "pediatricRadiologistList"),
        false, false, false,
        defaultWithDocumentBuilder(),
        AA_PARENT_EXPERT_REPORTS, 380, DEFAULT_NOTIFICATION_CONFIG, "pediatricRadiologistList"),

    PROFESSIONAL_DNA_TESTING("└─ Professional: DNA Testing", standardResolver(
        "profDNATestingList"),
        false, false, false,
        defaultWithDocumentBuilder(),
        AA_PARENT_EXPERT_REPORTS, 390, DEFAULT_NOTIFICATION_CONFIG, "profDNATestingList"),
    PROFESSIONAL_DRUG_ALCOHOL("└─ Professional: Drug/Alcohol", standardResolver(
        "profDrugAlcoholList"),
        false, false, false,
        defaultWithDocumentBuilder(),
        AA_PARENT_EXPERT_REPORTS, 400, DEFAULT_NOTIFICATION_CONFIG, "profDrugAlcoholList"),
    PROFESSIONAL_HAIR_STRAND("└─ Professional: Hair Strand", standardResolver(
        "professionalHairStrandList"),
        false, false, false,
        defaultWithDocumentBuilder(),
        AA_PARENT_EXPERT_REPORTS, 410, DEFAULT_NOTIFICATION_CONFIG, "professionalHairStrandList"),
    PROFESSIONAL_OTHER("└─ Professional: Other", standardResolver("professionalOtherList"),
        false, false, false,
        defaultWithDocumentBuilder(),
        AA_PARENT_EXPERT_REPORTS, 420, DEFAULT_NOTIFICATION_CONFIG, "professionalOtherList"),
    PSYCHIATRIC_CHILD_ONLY("└─ Psychiatric - On child only", standardResolver(
        "psychiatricChildOnlyList"),
        false, false, false,
        defaultWithDocumentBuilder(),
        AA_PARENT_EXPERT_REPORTS, 430, DEFAULT_NOTIFICATION_CONFIG, "psychiatricChildOnlyList"),
    PSYCHIATRIC_CHILD_AND_PARENT("└─ Psychiatric - On child and Parent(s)/carers", standardResolver(
        "psychChildParentCarersList"),
        false, false, false,
        defaultWithDocumentBuilder(),
        AA_PARENT_EXPERT_REPORTS, 440, DEFAULT_NOTIFICATION_CONFIG, "psychChildParentCarersList"),
    PSYCHOLOGICAL_REPORT_CHILD_ONLY_CLINICAL("└─ Psychological Report on Child Only - Clinical",
        ...
        false, false, false,
        defaultWithDocumentBuilder(),
        AA_PARENT_EXPERT_REPORTS, 450, DEFAULT_NOTIFICATION_CONFIG, "psycReportChildClinList"),
    PSYCHOLOGICAL_REPORT_CHILD_ONLY_EDUCATIONAL("└─ Psychological Report on Child Only - Educational",
        ...
        false, false, false,
        defaultWithDocumentBuilder(),
        AA_PARENT_EXPERT_REPORTS, 460, DEFAULT_NOTIFICATION_CONFIG, "psycReportChildOnlyEdList"),
    PSYCHOLOGICAL_REPORT_PARENT_AND_CHILD("└─ Psychological Report on Parent(s) and child",
        ...
        false, false, false,
        defaultWithDocumentBuilder(),
        AA_PARENT_EXPERT_REPORTS, 470, DEFAULT_NOTIFICATION_CONFIG, "psychReportParentChildList"),
    PSYCHOLOGICAL_REPORT_PARENT_FULL_COGNITIVE("└─ Psychological Report on Parent(s) - full cognitive",
        ...
        false, false, false,
        defaultWithDocumentBuilder(),
        AA_PARENT_EXPERT_REPORTS, 480, DEFAULT_NOTIFICATION_CONFIG, "psychRepParentFullCogList"),
    PSYCHOLOGICAL_REPORT_PARENT_FULL_FUNCTIONING("└─ Psychological Report on Parent(s) - functioning",
        ...
        false, false, false,
        defaultWithDocumentBuilder(),
        AA_PARENT_EXPERT_REPORTS, 490, DEFAULT_NOTIFICATION_CONFIG, "psychRepParentFuncList"),
    TOXICOLOGY_REPORT("└─ Toxicology report/statement", standardResolver(
        "toxicologyStatementList"),
        false, false, false,
        defaultWithDocumentBuilder(),
        AA_PARENT_EXPERT_REPORTS, 500, DEFAULT_NOTIFICATION_CONFIG, "toxicologyStatementList"),
    EXPERT_REPORTS("└─ Expert Reports", standardResolver("expertReportList"),
        true, true, true,
        defaultWithDocumentBuilder(),
        AA_PARENT_EXPERT_REPORTS, 901, DEFAULT_NOTIFICATION_CONFIG, "expertReports"),
    DRUG_AND_ALCOHOL_REPORTS("└─ Drug and alcohol reports", standardResolver("drugAndAlcoholReportList"),
        true, true, true,
        defaultWithDocumentBuilder(),
        AA_PARENT_EXPERT_REPORTS, 902, DEFAULT_NOTIFICATION_CONFIG, "drugAndAlcoholReports"),
    LETTER_OF_INSTRUCTION("└─ Letters of instruction / referrals", standardResolver(
        "lettersOfInstructionList"),
        true, true, true,
        defaultWithDocumentBuilder(),
        AA_PARENT_EXPERT_REPORTS, 903, DEFAULT_NOTIFICATION_CONFIG, "lettersOfInstructionReferrals"),
