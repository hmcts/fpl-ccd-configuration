...
public enum DocumentType {
    COURT_BUNDLE("Court Bundle", courtBundleResolver(),
        ...
        (document, documentUploaderType) -> HearingCourtBundle.builder()
            ...
            .build(),
        10, DEFAULT_MANAGED_DOCUMENTS_NOTIFICATION_CONFIG),
