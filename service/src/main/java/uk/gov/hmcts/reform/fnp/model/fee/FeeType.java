...
public enum FeeType {
    ...
    static {
        ...
        orderToFeeMap.put(OrderType.EDUCATION_SUPERVISION__ORDER, EDUCATION_SUPERVISION__ORDER);
    ...
    private static final Map<OtherApplicationType, FeeType> applicationToFeeMap = Map.of(
        ...
        C17_EDUCATION_SUPERVISION_ORDER, EDUCATION_SUPERVISION__ORDER,
