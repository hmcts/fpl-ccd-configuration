...
public class NotificationHandler {
    ...
    private final FinalOrderEmailContentProvider finalOrderEmailContentProvider;
    ...
    @EventListener
    public void sendNotificationForFinalOrder(final FinalOrderEvent event) {
        CaseDetails caseDetails = event.getCallbackRequest().getCaseDetails();
        String localAuthorityCode = (String) caseDetails.getData().get(CASE_LOCAL_AUTHORITY_PROPERTY_NAME);
    ...
    private void sendOrderNotificationForLocalAuthority(final CaseDetails caseDetails, final String localAuthorityCode,
        ...
        sendNotification(FINAL_ORDER_NOTIFICATION_TEMPLATE, localAuthorityEmail, localAuthorityParameters,
