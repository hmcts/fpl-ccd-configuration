...
public enum DocmosisTemplates {
    C110A("FL-PLW-APP-ENG-C110A-V6.doc", "FL-PLW-APP-WEL-00753-V7.doc", "c110a_application_%s"),
    C1("FL-PLW-APP-ENG-01084-V8.doc", null, "c1_application_%s"),
    ...
    ORDER_V2("FL-PLW-GOR-ENG-00728V4.doc", null, "order"),
    ...
    APPROVED_ORDER_COVER("FL-PLW-GOR-ENG-APPROVED-ORDER-COVER-SHEET-V2.docx",
    ...
    APPLICATION_REFUSAL_ORDER("FL-PLW-GOR-ENG-APPLICATION-REFUSAL-ORDER.docx", null, "application_refusal_order"),
