...
@Service
public class FinalOrderEmailContentProvider extends AbstractEmailContentProvider {

    private final LocalAuthorityNameLookupConfiguration localAuthorityNameLookupConfiguration;
    private final CafcassLookupConfiguration cafcassLookupConfiguration;
    private final ObjectMapper objectMapper;

    public FinalOrderEmailContentProvider(@Value("${ccd.ui.base.url}") String uiBaseUrl,
    ...
    public Map<String, Object> buildFinalOrderNotificationParametersForLocalAuthority(final CaseDetails caseDetails,
