...
@Service
public class CMOEmailContentProvider extends AbstractEmailContentProvider {

    private final LocalAuthorityNameLookupConfiguration localAuthorityNameLookupConfiguration;
    private final CafcassLookupConfiguration cafcassLookupConfiguration;
    private final ObjectMapper objectMapper;

    public CMOEmailContentProvider(@Value("${ccd.ui.base.url}")String uiBaseUrl,
    ...
    public Map<String, Object> buildCMONotificationParametersForCafcass(final CaseDetails caseDetails,
                                                                             final String localAuthorityCode,
                                                                          final String mostRecentUploadedDocumentUrl) {
        return ImmutableMap.<String, Object>builder()
            .putAll(commonCMONotificationParameters(caseDetails, mostRecentUploadedDocumentUrl))
            .put("localAuthorityOrCafcass", cafcassLookupConfiguration.getCafcass(localAuthorityCode).getName())
            .build();
    }

    public Map<String, Object> buildCMONotificationParametersForRespondents(final CaseDetails caseDetails,
                                                                                    final String localAuthorityCode,
                                                                          final String mostRecentUploadedDocumentUrl) {
        return ImmutableMap.<String, Object>builder()
            .putAll(commonCMONotificationParameters(caseDetails, mostRecentUploadedDocumentUrl))
    ...
    private Map<String, Object> commonCMONotificationParameters(final CaseDetails caseDetails,
