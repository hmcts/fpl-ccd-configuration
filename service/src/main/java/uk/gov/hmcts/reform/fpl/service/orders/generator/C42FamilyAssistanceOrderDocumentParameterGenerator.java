...
public class C42FamilyAssistanceOrderDocumentParameterGenerator implements DocmosisParameterGenerator {
    ...
    public static final String CONDITIONS_MESSAGE = "\n\nWhere - \n"
    ...
    public static final String DIRECTIONS_MESSAGE = "\nthe officer may apply to the court for it to revive the previous "
        + "proceedings and to consider that risk assessment and give such directions as the court thinks necessary.";

    public static final String NOTICE_MESSAGE = "\n\nNotice\nThis order will have effect for 12 months from the date " +
        "below, or such lesser period as specified.";
    ...
    private String buildOrderDetails(ManageOrdersEventData eventData) {
        ...
        stringBuilder.append(NOTICE_MESSAGE);
    ...
    private String getOrderRecitalsAndPreambles(ManageOrdersEventData eventData) {
        ...
        stringBuilder.append("an officer of the service to be made available to advise," +
    ...
    private String getOrderEnd(ManageOrdersEventData eventData) {
        return "This order ends on " + String.format(
