...
import uk.gov.hmcts.reform.fpl.service.orders.prepopulator.question.ApplicantSelectorBlockPrePopulator;
...
public class OrderSectionAndQuestionsPrePopulatorHolder {
    ...
    private final ApplicantSelectorBlockPrePopulator applicantSelectorBlockPrePopulator;
    ...
    public Map<OrderQuestionBlock, QuestionBlockOrderPrePopulator> questionBlockToPopulator() {
        ...
        blockOrderPrePopulatorMap = List.of(
            ...
            applicantSelectorBlockPrePopulator
