...
public class RoboticsLoggerHelper {
    ...
    public static void logAndThrowException(final RuntimeException roboticsException,
                                             final RoboticsData roboticsData) {
    ...
    public static void logEmailNotificationError(final RuntimeException exception, final String familyManNumber,
                                                  final Long caseId) {
        String errorMessage =
            String.format("Email notification failed for case with id %1$s and family man number %2$s due to %3$s",
