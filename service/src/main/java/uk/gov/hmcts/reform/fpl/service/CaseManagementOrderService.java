...
public class CaseManagementOrderService {
    ...
    public DynamicList buildDynamicListCMO(List<Element<uk.gov.hmcts.reform.fpl.model.order.CaseManagementOrder>> cmos) {
        return buildDynamicListCMO(cmos, null);
    }

    public DynamicList buildDynamicListCMO(List<Element<uk.gov.hmcts.reform.fpl.model.order.CaseManagementOrder>> cmos, UUID selected) {
