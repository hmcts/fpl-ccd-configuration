...
public class ApplicationRefusalOrderService extends AbstractApplicationGeneratedOrderService {
    ...
    private DocmosisApplicationRefusalOrder getTemplateData(CaseData caseData,
                                                             String judgeTitleAndName,
                                                             String dateOfRefusal,
    ...
    public String getRefusalOrderTitle(String applicationDate) {
        return buildApplicationOrderTitle(REFUSAL_ORDER.getLabel(), applicationDate);
    }
}
