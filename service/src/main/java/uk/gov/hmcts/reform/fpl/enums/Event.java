...
public enum Event {
    ...
    ORDERS_NEEDED("ordersNeeded", "Orders and directions sought", List.of(OPEN)),
    HEARING_NEEDED("hearingNeeded", "Hearing urgency", List.of(OPEN, RETURNED)),
    ...
    APPLICANT("enterApplicant", "Your organisation's details", List.of(OPEN, RETURNED)),
    ...
    ATTENDING_THE_HEARING("attendingHearing", "Court services needed", List.of(OPEN, RETURNED)),
