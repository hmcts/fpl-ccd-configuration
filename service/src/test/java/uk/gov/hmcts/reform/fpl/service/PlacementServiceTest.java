...
class PlacementServiceTest {
    ...
    class Init {
        ...
        @Test
        void shouldPrepareListOfChildrenWithoutPlacement2() {
            ...
            final CaseData caseData = CaseData.builder()
                ...
                .placementEventData(PlacementEventData.builder().placements(wrapElements(placement)).build())
                .build();
        ...
        @Test
        void shouldPrepareListOfChildrenWithoutPlacement3() {
        ...
        @Test
        void shouldPrepareListOfChildrenWithoutPlacement4() {
        ...
        @Test
        void shouldPrepareListOfChildrenWithoutPlacement5() {
    ...
    class PreparePlacement {
        ...
        void shouldPreparePlacement() {
            ...
            DynamicList childrenList = dynamicList(1, child1, child2, child3);
        ...
        void shouldThrowsExceptionWhenChildNotSelected() {
            ...
            DynamicList childrenList = dynamicList(child1, child2, child3);
    ...
    class CheckPayment {
        ...
        void shouldNormaliseAndValidateCorrectPBANumber() {
            ...
            List<String> actualErrors = underTest.checkPayment(caseData);
    ...
    class Save {
        ...
        @Test
        void shouldThrowsExceptionWhenNoApplicationDocument() {
            ...
            assertThatThrownBy(() -> underTest.savePlacement(caseData))
                .isInstanceOf(IllegalStateException.class)
                .hasMessage("Can not save placement without application document");
        }
