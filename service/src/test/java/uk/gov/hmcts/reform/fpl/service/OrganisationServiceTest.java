...
class OrganisationServiceTest {
    ...
    class FindUserByEmail {
        ...
        void shouldNotReturnUserIdIfUserNotPresent() {
            Exception exception = feignException(SC_NOT_FOUND);
        ...
        void shouldRethrowExceptionOtherThanNotFound() {
            ...
            Exception exception = feignException(SC_INTERNAL_SERVER_ERROR, email);

            when(organisationApi.findUserByEmail(AUTH_TOKEN, SERVICE_AUTH_TOKEN, email)).thenThrow(exception);
