...
class IdamErrorDecoderTest {
    ...
    private static final Exception RETRYABLE_EXCEPTION = new RetryableException(500, "", null, (Long) null, REQUEST);
    ...
    void shouldReturnNewRetryableErrorWhen500ResponseStatus() {
        ...
        RetryableException expectedException = new RetryableException(
            STATUS_5XX, EMPTY_REASON, GET, NON_RETRYABLE_EXCEPTION, (Long) null, REQUEST
        );
