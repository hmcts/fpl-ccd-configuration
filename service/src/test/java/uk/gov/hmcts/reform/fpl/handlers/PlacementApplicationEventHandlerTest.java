...
class PlacementApplicationEventHandlerTest {
    ...
    @Test
    void shouldNotTakePaymentsWhenItIsNotRequired() {
        ...
        assertThat(logs.get()).containsExactly("Payment not required for placement for case 1");
    ...
    void shouldTakeCourtPaymentWhenRequiredAndUpdatePaymentTimestamp() {
        ...
        verify(coreCaseDataService).updateCase(1L, expectedCaseUpdates);
    ...
    @Test
    void shouldNotNotifyUpdateCaseWhenUnexpectedException() {
