...
class CaseSubmissionCheckerTest {
    ...
    @Nested
    class EventsForCaseSubmissionIncludingDocumentsWhenApplicationDocumentsEventIsToggledOff {
    ...
    @Nested
    class EventsForCaseSubmissionExcludingDocumentsWhenApplicationEventIsToggledOn {
