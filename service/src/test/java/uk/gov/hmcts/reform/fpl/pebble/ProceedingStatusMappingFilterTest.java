...
public class ProceedingStatusMappingFilterTest {

    private static final ImmutableMap<String, Object> NO_ARGS = ImmutableMap.<String, Object>builder().build();

    private ProceedingStatusMappingFilter filter = new ProceedingStatusMappingFilter();
    ...
    void shouldThrowIllegalArgumentExceptionWithIncorrectEnum() {
        ...
        Assertions.assertThatThrownBy(() -> filter.apply(incorrectEnum, NO_ARGS))
            ...
            .hasMessage("No enum constant uk.gov.hmcts.reform.fpl.config.utils.ProceedingStatusType."
                + incorrectEnum);
    }
}
