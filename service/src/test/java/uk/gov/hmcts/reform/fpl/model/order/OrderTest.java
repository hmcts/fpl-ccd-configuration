...
class OrderTest {
    ...
    private static Stream<Arguments> sectionsWithNext() {
        return Stream.of(
            ...
            Arguments.of(C36_VARIATION_OR_EXTENSION_OF_SUPERVISION_ORDERS, ISSUING_DETAILS, Optional.of(CHILDREN_DETAILS)),
            Arguments.of(C36_VARIATION_OR_EXTENSION_OF_SUPERVISION_ORDERS, CHILDREN_DETAILS, Optional.of(ORDER_DETAILS)),
            Arguments.of(C36_VARIATION_OR_EXTENSION_OF_SUPERVISION_ORDERS, ORDER_DETAILS, Optional.of(REVIEW)),
