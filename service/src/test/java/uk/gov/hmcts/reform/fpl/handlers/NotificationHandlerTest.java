...
class NotificationHandlerTest {
    ...
    class C2UploadedNotificationChecks {
        final String mostRecentUploadedDocumentUrl = "http://fake-document-gateway/documents/79ec80ec-7be6-493b-b4e6"
            + "-f002f05b7079/binary";
        ...
        void before() throws IOException {
            ...
            given(finalOrderEmailContentProvider.buildFinalOrderNotificationParameters(
        ...
        void shouldNotifyPartiesOnFinalOrderSubmission() throws IOException, NotificationClientException {
            notificationHandler.sendNotificationForFinalOrder(
                new FinalOrderEvent(callbackRequest(), AUTH_TOKEN, USER_ID,
