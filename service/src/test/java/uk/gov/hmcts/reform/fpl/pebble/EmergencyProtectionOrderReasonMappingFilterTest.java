...
public class EmergencyProtectionOrderReasonMappingFilterTest {
    ...
    @ParameterizedTest()
    @CsvSource({
        "POSSIBLE_HARM_IF_NOT_PLACED_IN_PROVIDED_ACCOMMODATION, 'There’s reasonable cause to believe the child is "
            + "likely to suffer significant harm if they’re not moved to accommodation provided by you, or on "
            + "your behalf'",
        "POSSIBLE_HARM_IF_KEPT_IN_CURRENT_ACCOMMODATION, 'There’s reasonable cause to believe the child is likely to "
