...
class DraftsOrdersUploadedEventHandlerTest {
    ...
    void shouldSendNotificationToHearingJudge() {
        ...
        final CaseData caseData = CaseData.builder()
            ...
            .draftHearingOrdersBundles(wrapElements(bundle1, selectedHearingBundle))
            .lastDraftOrdersHearingId(selectedHearing.getId())
            .build();
    ...
    void shouldNotSendEmailIfNoHearingOrders() {
        ...
        final CaseData caseData = CaseData.builder()
            .id(RandomUtils.nextLong())
            .allocatedJudge(allocatedJudge())
            .draftHearingOrdersBundles(null)
            .build();
    ...
    void shouldNotSendEmailIfNoJudgeEmail() {
        ...
        CaseData caseData = CaseData.builder()
            ...
            .draftHearingOrdersBundles(ElementUtils.wrapElements(bundle))
            .lastDraftOrdersHearingId(hearing1.getId())
            .allocatedJudge(null)
            .build();
