...
class UpdateSummaryTabTest {
    ...
    @BeforeEach
    void initMocks() {
        underTest = new UpdateSummaryTab(mapper, searchService, ccdService, toggleService, summaryService);
    ...
    void shouldUseNonStandardQueryWhenFirstRunIsEnabled() {
        ...
        verify(searchService).search(FIRST_RUN_ES_QUERY);
        verify(searchService, never()).search(ES_QUERY);
    }
    ...
    void shouldUseStandardQueryWhenFirstRunIsDisabled() {
        ...
        verify(searchService).search(ES_QUERY);
        verify(searchService, never()).search(FIRST_RUN_ES_QUERY);
    }
