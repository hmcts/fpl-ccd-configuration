...
class UploadCMOServiceTest {
    ...
    class InitialData {
        ...
        void shouldBuildDynamicListsFromHearings() {
            ...
            assertThat(eventData.getDraftOrderHearings()).isEqualTo(allHearings);
        }
    }
    ...
    class DraftsInfo {
        ...
        void shouldPullHearingInfoForNewCMO() {
            ...
            UploadDraftOrdersData eventData = UploadDraftOrdersData.builder()
                ...
                .draftOrderKinds(List.of(HearingOrderKind.CMO))
                .build();
            ...
            assertThat(cmoInfo.getShowReplacementCMO()).isEqualTo(YesNo.NO);
        ...
        void shouldRegenerateDynamicListsIfIdsPassedAsStrings() {
            ...
            UploadDraftOrdersData eventData = UploadDraftOrdersData.builder()
                ...
                .draftOrderHearings(DEFAULT_CODE.toString())
                .build();
            ...
            assertThat(cmoInfo.getDraftOrderHearings()).isEqualTo(allHearings);
        }
        ...
        void shouldProvideEmptyDraftOrdersIfOrdersNotPresentForSelectedHearing() {
            ...
            UploadDraftOrdersData eventData = UploadDraftOrdersData.builder()
                .draftOrderKinds(List.of(HearingOrderKind.C21))
                .draftOrderHearings(dynamicList(hearings.get(0).getId(), hearings))
                .build();
            ...
            assertThat(reviewData.getHearingDraftOrders()).extracting(Element::getValue)
        ...
        void shouldProvideNonCmoDraftOrdersForSelectedHearing() {
            ...
            UploadDraftOrdersData eventData = UploadDraftOrdersData.builder()
                .draftOrderKinds(List.of(HearingOrderKind.C21))
                .draftOrderHearings(dynamicList(selectedHearing.getId(), List.of(selectedHearing, otherHearing)))
                .build();
            ...
            CaseData caseData = CaseData.builder()
                .hearingDetails(hearings)
                .uploadDraftOrdersEventData(eventData)
                .draftHearingOrdersBundles(wrapElements(selectedHearingOrdersBundle, otherHearingOrdersBundle))
                .build();

            UploadDraftOrdersData actualEventData = service.getDraftsInfo(caseData);

            assertThat(actualEventData.getHearingDraftOrders()).containsExactly(hearingOrder2, hearingOrder3);
        }
        ...
        void shouldProvideNonCmoDraftOrdersWhenNoHearingSelected() {
            ...
            UploadDraftOrdersData eventData = UploadDraftOrdersData.builder()
                .draftOrderKinds(List.of(HearingOrderKind.C21))
                .draftOrderHearings(dynamicList(DEFAULT_CODE, List.of(hearings.get(0), hearings.get(1)),
            ...
            CaseData caseData = CaseData.builder()
                .hearingDetails(hearings)
                .uploadDraftOrdersEventData(eventData)
                .draftHearingOrdersBundles(ElementUtils.wrapElements(hearingOrdersBundle, noHearingOrdersBundle))
                .build();
    ...
    class UpdateCase {
        ...
        void shouldCreateOrderBundleIfDoesNotExists() {
            ...
            UploadDraftOrdersData eventData = UploadDraftOrdersData.builder()
                .draftOrderKinds(List.of(HearingOrderKind.C21))
                .draftOrderHearings(dynamicList(hearings.get(0).getId(), hearings))
                .hearingDraftOrders(newArrayList(hearingOrder1, hearingOrder2))
                .build();
        ...
        void shouldUpdateExistingOrdersBundle() {
            ...
            UploadDraftOrdersData eventData = UploadDraftOrdersData.builder()
                .draftOrderKinds(List.of(HearingOrderKind.C21))
                .draftOrderHearings(dynamicList(selectedHearing.getId(), hearings))
                .hearingDraftOrders(List.of(hearingOrder1, hearingOrder3))
                .build();
    ...
    class MigrateCMODrafts {
        ...
        void shouldPreserveOriginalOrdersBundleIfNoUpdatedCMO() {
            ...
            CaseData caseData = CaseData.builder()
                .draftHearingOrdersBundles(wrapElements(originalOrdersBundle))
                .build();
        ...
        void shouldAddCmoOrderToExistingOrdersBundle() {
            ...
            CaseData caseData = CaseData.builder()
                .draftHearingOrdersBundles(wrapElements(
        ...
        void shouldUpdateCmoOrderInExistingOrdersBundle() {
            ...
            CaseData caseData = CaseData.builder()
                .draftHearingOrdersBundles(wrapElements(originalHearing1OrdersBundle, originalHearing2OrdersBundle))
                .hearingDetails(List.of(hearing1, hearing2))
                .draftUploadedCMOs(List.of(newHearing1CmoOrder))
                .build();
