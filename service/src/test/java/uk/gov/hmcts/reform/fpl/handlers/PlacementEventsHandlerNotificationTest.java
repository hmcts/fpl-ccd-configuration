...
class PlacementEventsHandlerNotificationTest {
    ...
    class CourtNotification {
        ...
        void shouldSendNotificationToCourtWhenNewPlacementApplicationSubmitted() {
            ...
            verify(notificationService).sendEmail(PLACEMENT_APPLICATION_UPLOADED_COURT_TEMPLATE, courtEmail,
                notifyData, CASE_ID);
    ...
    class LocalAuthorityNotification {
        ...
        void shouldSendNotificationToLocalAuthority() {
            ...
            verify(notificationService).sendEmail(PLACEMENT_NOTICE_UPLOADED_TEMPLATE, recipients, notifyData, CASE_ID);
    ...
    class CafcassNotification {
        ...
        void shouldSendNotificationToCafcass() {
            ...
            verify(notificationService).sendEmail(PLACEMENT_NOTICE_UPLOADED_CAFCASS_TEMPLATE, cafcass.getEmail(),
                notifyData, CASE_ID);
    ...
    class ParentsNotification {
        ...
        void shouldSendNotificationToFirstParentSolicitor() {
            ...
            verify(notificationService).sendEmail(PLACEMENT_NOTICE_UPLOADED_TEMPLATE, parentSolicitor.getEmail(),
                notifyData, CASE_ID);
        }
        ...
        void shouldSendLetterWhenParentNotRepresented() {
            ...
            verify(sendDocumentService).sendDocuments(caseData, List.of(notice.getNotice()), List.of(respondent.getValue().getParty()));
        }
