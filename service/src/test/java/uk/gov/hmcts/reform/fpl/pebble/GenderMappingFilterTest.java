...
public class GenderMappingFilterTest {
    ...
    void shouldThrowIllegalArgumentExceptionWithIncorrectEnum() {
        ...
        Assertions.assertThatThrownBy(() -> filter.apply(incorrectEnum, NO_ARGS))
            ...
            .hasMessage("No enum constant uk.gov.hmcts.reform.fpl.config.utils.GenderListType."
                + incorrectEnum);
    }
}
