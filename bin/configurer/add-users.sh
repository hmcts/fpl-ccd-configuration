...
${dir}/utils/idam-create-caseworker.sh "gatekeeper1@mailnesia.com" "caseworker,caseworker-publiclaw,caseworker-publiclaw-gatekeeper,caseworker-publiclaw-courtadmin" "(gatekeeper)"
