...
${dir}/utils/idam-create-caseworker.sh "judiciary@mailnesia.com" "caseworker,caseworker-publiclaw,caseworker-publiclaw-judiciary,caseworker-publiclaw-gatekeeper" "(judiciary)"
