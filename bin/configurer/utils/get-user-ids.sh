...
sed -i '' "s/31,32,33/$useridswithoutwhitespace/" "../../../service/src/main/resources/application-user-mappings.yaml"
sed -i '' "s/31,32,33/$useridswithoutwhitespace/" "../../../build/resources/main/application-user-mappings.yaml"
