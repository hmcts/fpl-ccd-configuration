...
roles=("solicitor" "courtadmin" "cafcass" "magistrate" "gatekeeper" "systemupdate" "judiciary" "bulkscan" "bulkscansystemupdate" "localAuthority" "superuser" "cafcasssystemupdate, rparobot")
for role in "${roles[@]}"
do
...
${dir}/utils/ccd-add-role.sh "legal-adviser"
${dir}/utils/ccd-add-role.sh "TTL_profile"
