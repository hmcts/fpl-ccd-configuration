...
export const urlConfig: UrlConfig = {
  ...
  serviceUrl: process.env.CASE_SERVICE_URL || `http://fpl-case-service-${env}.service.core-compute-${env}.internal`,
   // serviceUrl: process.env.CASE_SERVICE_URL || `https://fpl-case-service-pr-5494.preview.platform.hmcts.net`,
  ...
  cafcassAPISearch: process.env.CAFCASS_SEARCH_URL || `https://fpl-case-service-pr-5494.preview.platform.hmcts.net/cases`
