...
export class GroundsForTheApplication {
    ...
    readonly notReceivingCareThatWouldBeResonablyExpectedFromAParentCheckBox: Locator;
    readonly giveDetailsOfHowThisCaseMeetsTheThresholdCriteriaTextBox: Locator;
    ...
    async groundsForTheApplicationSmokeTest() {
        ...
        await this.notReceivingCareThatWouldBeResonablyExpectedFromAParentCheckBox.click();
        await this.giveDetailsOfHowThisCaseMeetsTheThresholdCriteriaTextBox.fill('Eum laudantium tempor, yet magni beatae. Architecto tempor. Quae adipisci, and labore, but voluptate, but est voluptas. Ipsum error minima. Suscipit eiusmod excepteur veniam. Consequat aliqua ex. Nostrud elit nostrum fugiat, yet esse nihil. Natus anim perspiciatis, and illum, so magni. Consequuntur eiusmod, so error. Anim magna. Dolores nequeporro, yet tempora. Amet rem aliquid.');
        await this.notReceivingCareThatWouldBeResonablyExpectedFromAParentCheckBox.isChecked();
