...
export class OtherPeopleInCase extends BasePage {
    ...
    async personTwoToBeGivenNotice() {
        ...
        await this.page.locator('#othersV2_1_firstName').fill('Jane');
        await this.page.locator('#othersV2_1_lastName').fill('Law');
        await this.page.locator('#DOB-day').nth(1).fill('11');
