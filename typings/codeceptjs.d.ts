...
declare namespace CodeceptJS {
  export interface I {
    ...
    fillDate(date: {day: number, month: number, year: number, hour: number, minute: number, second: number}, dateId: string): void,
  }
